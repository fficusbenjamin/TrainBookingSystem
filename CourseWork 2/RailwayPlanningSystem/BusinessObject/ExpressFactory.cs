...
///                   TrainFactory class to create the an express train
///                   object
///                   
...
{
    public class ExpressFactory : TrainFactory
    {
        ...
        //method to call to create an expressFactory that requires inputting an id that
        //gets set as the train id
        public ExpressFactory(string trainID)
        {
            _trainID = trainID;
        ...
        public override Train GetTrainType()
        {
            ...
            return new Express(_trainID, _dep, _dest, _type, _nc, _yk, _dg, _pb, _hour, _minute, _day, _berth, _fClass);
        }
    }
}
