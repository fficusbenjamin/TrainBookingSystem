...
///----------------------------------------------------------------------------
///   Class:          Stopping (that inherit from the Train abstract class)
///   Description:    This is an inherited class that holds all the properties
///                   and methods necessary to the creation of a stopping train.
///                   
...
namespace BusinessObject
{
    class Stopping : Train
    {
        ...
        public Stopping(string trainID, string departure, string destination, string type, string nc, string yk, string dg, string pb, string hour, string minute, string day, bool berth, bool fClass)
        {
            _trainType = "Stopping";
            _trainID = trainID;
            _dep = departure;
            ...
            _minute = minute;
            _day = day;
            //stopping train don't have a sleeper berth
            _berth = false;
            _fClass = fClass;
